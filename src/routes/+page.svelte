...
<main>
  <div>
    ...
    <h1 class="name">Isak Bengtsson </h1>
    ...
    <p id="inspo_senna">
    "If you no longer go for a gap that exists, you are no longer a Racing driver." - <strong>Aryton Senna</strong>, 3 time <strong>F1</strong> champion.
    </p>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#0099ff" fill-opacity="1" d="M0,320L16,314.7C32,309,64,299,96,282.7C128,267,160,245,192,208C224,171,256,117,288,122.7C320,128,352,192,384,208C416,224,448,192,480,160C512,128,544,96,576,85.3C608,75,640,85,672,122.7C704,160,736,224,768,229.3C800,235,832,181,864,154.7C896,128,928,128,960,133.3C992,139,1024,149,1056,165.3C1088,181,1120,203,1152,218.7C1184,235,1216,245,1248,240C1280,235,1312,213,1344,181.3C1376,149,1408,107,1424,85.3L1440,64L1440,320L1424,320C1408,320,1376,320,1344,320C1312,320,1280,320,1248,320C1216,320,1184,320,1152,320C1120,320,1088,320,1056,320C1024,320,992,320,960,320C928,320,896,320,864,320C832,320,800,320,768,320C736,320,704,320,672,320C640,320,608,320,576,320C544,320,512,320,480,320C448,320,416,320,384,320C352,320,320,320,288,320C256,320,224,320,192,320C160,320,128,320,96,320C64,320,32,320,16,320L0,320Z"></path></svg>